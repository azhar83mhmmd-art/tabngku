...
const App = (() => {
  ...
  function init(){
    if (typeof AppLock !== 'undefined') AppLock.initialCheck();
    ...
    if (typeof BackupScheduler !== 'undefined') BackupScheduler.checkAndRun();
    setupQuickAmounts();
  ...
  function renderStats(){
    ...
    if (typeof InsightsModule !== 'undefined') InsightsModule.renderAll();
  }
  ...
  function refreshGlobalViews(){
    ...
    Dashboard.render();
    if (typeof InsightsModule !== 'undefined') InsightsModule.checkAchievements();
    if (activePage){
